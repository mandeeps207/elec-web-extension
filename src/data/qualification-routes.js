// Approved bounded guidance; this checker does not determine qualification eligibility.
...
const review = { status: 'approved', approvedBy: 'Charanjit Mannu', approvedOn: '2026-09-14', lastReviewed: '2026-09-14' };
export const routes = [
  {
    id: 'new', label: 'I’m completely new', state: 'resolved', heading: copy.resultHeading,
  ...
  {
    id: 'level-2', label: 'I’ve completed Level 2', state: 'resolved', heading: copy.resultHeading,
  ...
  {
    id: 'level-3', label: 'I’ve completed Level 3', state: 'resolved', heading: copy.resultHeading,
  ...
  {
    id: 'site-experience', label: 'I’m currently gaining site experience', state: 'resolved', heading: copy.unresolvedHeading,
  ...
  {
    id: 'experienced', label: 'I’m an experienced electrician', state: 'resolved', heading: copy.unresolvedHeading,
